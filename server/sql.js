module.exports = {
  ...
  selectAirDataOnDate: {
    // ? type -> text(VARCHAR) -> '202211100000' -> yyyymmddhhmm
  ...
  selectAirFloorData: {
    query: `SELECT * FROM airData WHERE obsDate = (SELECT MAX(obsDate) FROM airData)`
  }
}
